...
use Joomla\Component\Content\Site\View\Article\HtmlView;
...
<article class="com-content-article item-page<?php echo $this->pageclass_sfx; ?>">
    ...
    <?php if (!empty($this->item->fulltext)) : ?>
        <div class="description"><?php echo HTMLHelper::_('content.prepare', $this->item->introtext); ?></div>
    <?php endif; ?>
    ...
    <?php if ($params->get('access-view')) : ?>
        ...
        <section class="com-content-article-body">
            <?php if (empty($this->item->fulltext)) : ?>
