            ...
            <div class="header-top">
                ...
                <?php if ($this->countModules('header-search')) : ?>
                    <div class="header-search-trigger">
                        <button class="br-button circle" type="button" aria-label="<?php echo Text::_('TPL_GOVBR_OPEN_SEARCH'); ?>" data-toggle="search" data-target=".header-search">
    ...
    <main class="d-flex flex-fill mb-5">
        <div class="container-lg">
            ...
            <div class="main-content pl-sm-3 mt-4" id="main-content">
                <h1><?php echo $this->error->getCode() == 404 ? Text::_('JERROR_LAYOUT_PAGE_NOT_FOUND') : htmlspecialchars($this->error->getMessage(), ENT_QUOTES, 'UTF-8'); ?></h1>
                <div class="template-erro">
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="text-support-03">
                                <p class="text-up-06 text-semi-bold my-3"><?php echo Text::_('JERROR_LAYOUT_ERROR_HAS_OCCURRED_WHILE_PROCESSING_YOUR_REQUEST'); ?></p>
                            </div>

                            <div class="text-secondary-06">
                                <p class="text-up-03 text-medium my-3"><?php echo Text::_('JERROR_LAYOUT_NOT_ABLE_TO_VISIT'); ?></p>
                            </div>
                    ...
                    <div class="row my-5 text-center justify-content-lg-center">
                        <div class="col-lg-auto mt-1 mt-lg-0">
                            <a class="br-button" href="<?php echo $this->baseurl; ?>/index.php">
                                <i class="fas fa-home" aria-hidden="true"></i>
                                <span><?php echo Text::_('JERROR_LAYOUT_GO_TO_THE_HOME_PAGE'); ?></span>
                            </a>
                        </div>

                        <div class="col-lg-auto mt-1 mt-lg-0">
                            <a class="br-button" href="mailto:<?php echo $app->getCfg('mailfrom'); ?>" target="_blank">
                                <i class="fas fa-comment-dots" aria-hidden="true"></i>
                                <span><?php echo Text::_('TPL_GOVBR_SEND_FEEDBACK'); ?></span>
                            </a>
                        </div>
                    </div>
